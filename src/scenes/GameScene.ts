...
export class GameScene extends Phaser.Scene {
  ...
  private useKenneyHero = false
  private heroFrameW = HERO_W
  private heroFrameH = HERO_H
  ...
  init() {
    // Keep this in init so preload/create can reference it reliably.
    this.useKenneyHero = typeof window !== 'undefined' && new URLSearchParams(window.location.search).has('kenneyHero')
    this.heroFrameW = this.useKenneyHero ? 64 : HERO_W
    this.heroFrameH = this.useKenneyHero ? 64 : HERO_H
  }

  preload() {
    // Default hero is generated by our script, but you can switch to Kenney's hero
    // by appending ?kenneyHero=1 to the URL.
    this.load.spritesheet('hero', this.useKenneyHero ? '/sprites/hero_kenney.png' : '/sprites/hero.png', {
      frameWidth: this.heroFrameW,
      frameHeight: this.heroFrameH,
    })
  ...
  create() {
    ...
    body.setSize(28, 28)
    body.setOffset((this.heroFrameW - 28) / 2, this.heroFrameH - 28 - 8)
